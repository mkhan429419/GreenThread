  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(updateACoupon.fulfilled, (state, action) => {
        ...
        const updatedCoupon = action.payload[0];

        if (updatedCoupon) {
          state.couponName = updatedCoupon.name || "";
          state.couponDiscount = updatedCoupon.discount || 0;
          state.couponExpiry = updatedCoupon.expiry || "";
        }
      })
