          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                ...
                <a
                  href="tel:+92 2344652345"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +92 2344652345
                </a>
                <a
                  href="mailto: greenthread@gmail.com"
            ...
            <div className="col-2">
              ...
              <div className="footer-links d-flex flex-column">
                ...
                <Link className="text-white py-2 mb-1">Bottoms</Link>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy;{new Date().getFullYear()}; Powered by GreenThread.Inc
              </p>
            </div>
          </div>
        </div>
